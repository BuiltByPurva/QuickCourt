...
import BookingTrendsChart from '../../components/Common/BookingTrendsChart';
import EarningsSummaryChart4 from '../../components/Common/EarningsSummaryChart';
import { 
  MapPin, 
  Users, 
  Calendar, 
...
const OwnerDashboard: React.FC = () => {
  ...
  const renderDashboardTab = () => (
    <div className="space-y-8" style={{marginBottom: '2rem'}}>
      ...
      <div className="bg-white rounded-xl p-8 flex items-center gap-6 shadow border border-gray-100 mb-4" style={{marginBottom: '1rem'}}>
        <div className="flex-shrink-0 w-20 h-20 rounded-full bg-gradient-to-br from-emerald-500 to-blue-600 flex items-center justify-center">
          <Users className="w-12 h-12 text-white" />
        </div>
        <div>
          <h2 className="text-2xl font-bold text-gray-900 mb-1">Welcome back, <span className="text-emerald-600">{user?.fullName}</span>!</h2>
          <p className="text-gray-600 text-lg">Your facilities are thriving. Check your stats and manage everything easily below.</p>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-200">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm font-medium text-gray-600 mb-1">Active Courts</p>
            <p className="text-2xl font-bold text-gray-900">{ownerStats.activeCourts}</p>
          </div>
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-200">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold text-gray-900">₹{ownerStats.earnings.toLocaleString()}</p>
          </div>
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-200">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold text-gray-900">{ownerStats.pendingBookings}</p>
          </div>
     ...
     <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        <h3 className="text-lg font-semibold text-gray-900 mb-4" style={{padding: '1rem'}}>Booking Trends</h3>
        <div className="h-64 bg-gray-50 rounded-lg flex items-center justify-center overflow-hidden">
          <div className="text-center text-gray-500">
            <BarChart3 className="w-12 h-12 mx-auto mb-3 text-gray-300" />
            <p className="text-base font-medium"><BookingTrendsChart /></p>
          </div>
        </div>
      </div>
      ...
      {/* Earnings Summary */}
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        <h3 className="text-lg font-semibold text-gray-900 mb-4"  style={{padding: '1rem'}}>Earnings Summary</h3>
        <div className="h-64 bg-gray-50 rounded-lg flex items-center justify-center overflow-hidden">
          <div className="text-center text-gray-500">
            <TrendingUp className="w-12 h-12 mx-auto mb-3 text-gray-300" />
            <p className="text-base font-medium"><EarningsSummaryChart4 /></p>
          </div>
        </div>
      </div>
    </div>
      ...
      {/* Quick Actions */}
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6" style={{marginTop: '2rem'}}>
        <h3 className="text-lg font-semibold text-gray-900 mb-5" style={{padding: '1rem'}}>Quick Actions</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button 
            onClick={() => setActiveTab('facilities')}
            className="p-5 border-2 border-dashed border-gray-200 rounded-lg hover:border-emerald-500 hover:bg-emerald-50 transition-all duration-200 text-center group"
          >
            <div className="flex flex-col items-center space-y-2">
              <Plus className="w-8 h-8 text-emerald-600 group-hover:scale-110 transition-transform duration-200" />
              <span className="font-medium text-gray-700 text-base">Add New Venue</span>
          ...
          <button 
            ...
            className="p-5 border-2 border-dashed border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-all duration-200 text-center group"
          >
            <div className="flex flex-col items-center space-y-2">
              <Building2 className="w-8 h-8 text-blue-600 group-hover:scale-110 transition-transform duration-200" />
              <span className="font-medium text-gray-700 text-base">Manage Courts</span>
          ...
          <button 
            ...
            className="p-5 border-2 border-dashed border-gray-200 rounded-lg hover:border-purple-500 hover:bg-purple-50 transition-all duration-200 text-center group"
          >
            <div className="flex flex-col items-center space-y-2">
              <Calendar className="w-8 h-8 text-purple-600 group-hover:scale-110 transition-transform duration-200" />
              <span className="font-medium text-gray-700 text-base">View Bookings</span>
      ...
      {/* Recent Bookings */}
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8" style={{margin: '1rem',padding: '1rem'}}> 
        <h3 className="text-xl font-semibold text-gray-900 mb-6">Recent Bookings</h3>
        <div className="space-y-4">
          {bookings.slice(0, 5).map((booking) => (
            <div key={booking.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg"  style={{padding: '1rem'}} >
